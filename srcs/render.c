...
/*   Updated: 2023/08/04 18:12:07 by fnacarel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_pixel(t_point point, int color, t_mlx mlx)
{
	mlx_img_pix_put(&mlx.img, point.x + ((double) WIDTH / 2), -point.y + ((double) HEIGHT / 2), color);
}
